...
uniform vec3 Ke;	// emission material
...
void main(){
	...
	vec4 textureEmission = texture(emissiveTexture, vTexCoord);
	...
	vec3 emission = Ke * textureEmission.rgb;
	
	FragColour = vec4(ambient + diffuse + specular + emission, 1);
}
